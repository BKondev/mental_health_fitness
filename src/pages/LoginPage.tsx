      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-sand-200">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center font-bold text-sand-800">Welcome back</CardTitle>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/forgot-password" className="text-xs text-sand-600 hover:text-sand-800">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="relative">
          ...
          <CardFooter className="flex justify-center">
            <p className="text-center text-sm text-sand-600">
              ...
              <Link to="/register" className="font-medium text-sand-700 hover:text-sand-800">
                Sign up
              </Link>
            </p>
          </CardFooter>
